...
We curated the survey questions based on our own experiences of being a student that has seen a shift of academic and professional ecosystem in the last 1.5 years. This inspired the study and therefore we wanted to understand what the students have been feeling during this time, the major concerns they have, what affected their study? Did they get better results? etc. The data was not only open-text questions but also likert scale method of scoring as well as categorical data etc. We understood the demographics of survey respondents, their age, location etc.


**How did you answer the questions?**

We started a basic pre-processing steps of cleaning the data, removing NAs, converting text data to lower case, and also stopword removal. We found answers of our research questions by performing a sentiment analysis on text data. We also tried to find correlation between different variables. These were integral to find out whether each variable contribute to other or not. We also ran ML models such as Logistic Regression in order to predict grades of Masters students. The most essential struggle for us was having not enough data. We highly emphasis on future work where we can have higher number of survey respondents - ideally more than 100 so we could have a better training and test data split and offer more promising results of the study.
